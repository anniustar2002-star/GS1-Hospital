    ...
    <div className="mx-auto max-w-6xl px-6 py-12">
      <header className="mb-10 text-center">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-slate-600">
          Recorre las salas principales de un hospital y vive, paso a paso, cómo un simple código de barras
          conecta cada producto, cada dosis y cada paciente con seguridad.
        </p>
      </header>
